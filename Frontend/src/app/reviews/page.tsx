      ...
      <div className="container mx-auto max-w-2xl">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-lg mx-auto leading-relaxed">
            Ayúdanos a mejorar StudyApp compartiendo tu experiencia. ¿Qué te gusta? ¿Qué podemos hacer mejor?
          </p>
        </motion.div>
        ...
        >
          {isSubmitted ? (
            <div className="p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
              ...
              <p className="text-slate-600">Valoramos mucho tus comentarios para seguir mejorando.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="p-8 md:p-10">
              ...
              <div className="mb-10 text-center">
                ...
                <div className="h-6 mt-2 text-sm font-medium text-indigo-600">
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="block w-full p-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none"
